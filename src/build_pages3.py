...
<section class="section">
  <div class="wrap">
    ...
    <div class="grid g-3">
      <div class="pillar rv">
        <p class="label label--accent">01</p>
      ...
      <div class="pillar rv" data-delay="60">
        <p class="label label--accent">02</p>
      ...
      <div class="pillar rv" data-delay="120">
        <p class="label label--accent">03</p>
...
def _fetch_published():
    ...
    for p in rows:
        ...
        out.append((p["slug"], p["title"], p.get("excerpt") or "",
                    p.get("tag") or "Insights", (p.get("tag") or "").lower(),
                    secs, closing))
...
def page_insights(mode, depth=0):
    cards = ""
...
<section class="section section--warm">
  <div class="wrap">
    {crumbs(mode, depth, [("Insights", None)])}
    <h1 class="t-display mb-3">Insights.</h1>
    <p class="t-lead measure">Straight answers about engineering careers, the software the industry actually uses, and what employers in this market are hiring for. Written by people who teach it.</p>
  </div>
</section>
...
<section class="section">
  <div class="wrap">
    ...
    <div class="note mt-6">
      More articles are published regularly. Tell us what you want explained &mdash; the questions we get asked most are the ones we write about next.
    </div>
  </div>
</section>
</main>
...
<article class="section">
  <div class="wrap" style="max-width:min(760px,100%)">
    {crumbs(mode, depth, [("Insights", "insights"), (tag, None)])}
