...
def page_home(mode, depth=0):
    ...
    if PARTNERS:
        ...
        def _logomark(pn, pf, pw, ph, dup=False):
            ...
            return (f'<div class="logomark"{" aria-hidden=\"true\"" if dup else ""}>'
    ...
    _aud = [
        ("01", "student",      "cap",       "College student",       "I want skills that go beyond my degree.",       "See student paths",  "career-paths"),
        ("02", "fresher",      "rocket",    "Fresher",               "I have the degree. I need to become employable.", "Find my path",      "finder"),
        ("03", "professional", "briefcase", "Working professional",  "I want to upskill, or move into a better role.", "Weekend options",   "programs"),
        ("04", "corporate",    "building",  "Employer or corporate", "I need to train my team, or hire trained people.", "Corporate training","corporate"),
    ]
    aud_cards = ""
    for i, (n, art, ic, title, desc, cta, route) in enumerate(_aud):
        ...
        aud_cards += (
            ...
            f'<div class="audcard__top"><span class="audcard__n">{n}</span>{icon(ic)}</div>'
    ...
    if STORIES:
        ...
        home_story_block = (
            '<div class="grid g-3">'
            '<div class="pillar"><p class="label label--accent">01</p>'
            ...
            '<div class="pillar"><p class="label label--accent">02</p>'
            ...
            '<div class="pillar"><p class="label label--accent">03</p>'
...
<section class="hero">
  <div class="hero__photo">{hero_picture(depth)}</div>
...
<section class="section section--warm section--rule">
  <div class="wrap">
    <div class="marker"><span class="label label--accent">Insights</span></div>
    <div class="flex jcb aic wrapf gap-3 mb-6">
      <h2 class="t-display">Worth reading before you decide.</h2>
      <a class="alink" {L("insights", mode, depth)}>All articles
        <svg viewBox="0 0 14 14" fill="none" aria-hidden="true"><path d="M1 7h12M8 2l5 5-5 5" stroke="currentColor" stroke-width="1.6"/></svg></a>
    </div>
    <div class="grid g-3">
...
<span><span class="acc2__n">{i+1:02d}</span>{q}</span><span class="plus" aria-hidden="true"></span></button>
