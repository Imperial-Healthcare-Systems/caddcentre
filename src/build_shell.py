...
def register_articles(slugs):
    ...
    for _s in slugs:
        ROUTES["article:" + _s] = f"insights/{_s}/index.html"
...
def header(mode, depth=0, active=""):
...
<header class="header">
  <div class="wrap header__inner">
    ...
    <nav class="nav" aria-label="Primary">
      ...
      {link("student-work", "Student Work")}
      {link("careers", "Careers")}
      {link("life", "Life @ CADD")}
      {link("corporate", "Industry")}
      {link("about", "About")}
...
<div class="drawer" id="drawer" data-drawer data-open="false" aria-hidden="true">
  ...
  <div class="drawer__body">
    ...
    <a class="acc__trigger" {L("student-work", mode, depth)}>Student Work</a>
    <a class="acc__trigger" {L("corporate", mode, depth)}>Industry &amp; Corporate</a>
...
def footer(mode, depth=0):
    ...
    company = "".join(f'<li><a {L(r, mode, depth)}>{n}</a></li>' for n, r in [
        ("About the centre", "about"), ("Careers &amp; placement", "careers"),
        ("First Job Pakka", "first-job-pakka"), ("Student work", "student-work"),
        ("Life @ CADD", "life"), ("Corporate training", "corporate"),
